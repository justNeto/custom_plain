...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
            ...
            KC_DEL,             KC_SCLN,        KC_COMMA,               KC_DOT,                 KC_P,                   KC_Y,       KC_AUDIO_VOL_UP,                KC_AUDIO_VOL_DOWN,          KC_F,           KC_G,               KC_C,               KC_R,           KC_L,       KC_TILDE,
    ...
    [4] = LAYOUT(
            ...
            KC_LEFT_SHIFT,      KC_F11,     KC_NO,              KC_LEFT,                KC_DOWN,            KC_DOT,     KC_NO,                                      KC_NO,          KC_COMMA,       KC_UP,     KC_RIGHT,   KC_F12,     KC_NO,      KC_RIGHT_SHIFT,
