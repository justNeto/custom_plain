...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
            TO(0),              KC_1,           KC_2,                   KC_3,                   KC_4,                   KC_5,       KC_PRINT_SCREEN,                KC_NO,                      KC_6,           KC_7,               KC_8,               KC_9,           KC_0,       TG(2),
            ...
            KC_LEFT_SHIFT,      KC_QUOTE,       KC_Q,                   KC_J,                   KC_K,                   KC_X,       TG(1),                          TG(2),                      KC_B,           KC_M,               KC_W,               KC_V,           KC_Z,       KC_RIGHT_SHIFT,
