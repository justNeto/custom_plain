...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
            ...
            TG(3),              KC_A,           KC_O,                   KC_E,                   KC_U,                   KC_I,       KC_QUESTION,                    KC_EXCLAIM,                 KC_D,           KC_H,               KC_T,               KC_N,           KC_S,       CW_TOGG,
            KC_LEFT_SHIFT,      KC_QUOTE,       KC_Q,                   KC_J,                   KC_K,                   KC_X,       KC_NO,                          KC_NO,                      KC_B,           KC_M,               KC_W,               KC_V,           KC_Z,       KC_RIGHT_SHIFT,
                                                LGUI_T(KC_ESCAPE),      LT(2, KC_SPACE),        LCTL_T(KC_TAB),                                                                                                 KC_LEFT_ALT,        KC_BACKSPACE,       KC_ENT
    ),
    ...
    [1] = LAYOUT(
            ...
            KC_TRNS,            KC_Z,           KC_X,                   KC_C,                   KC_V,               KC_B,       KC_M,                       KC_NO,        KC_N,         KC_M,           KC_COMMA,       KC_DOT,         KC_SCLN,        KC_TRNS,
                                                LALT_T(KC_A),           KC_TRNS,                KC_LEFT_CTRL,                                                                           KC_TRNS,        KC_TRNS,        KC_TRNS
    ),
